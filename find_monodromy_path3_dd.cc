 ...
 * c++ -I.. -O3 -DNDEBUG find_monodromy_path3_dd.cc -fopenmp
 * c++ -I.. -O3 -DNDEBUG -DKV_USE_AVX512 -mavx512f -DKV_USE_TPFMA find_monodromy_path3_dd.cc -fopenmp
 * 
...
phi4.resize(n);
//
/////// Define the path gamma_{3}
kv::complex<intval> x0, y0, x3, y3, r3;
...
ub::vector< kv::complex<intval> > phi1_path3;
ub::vector< kv::complex<intval> > phi2_path3;
ub::vector< kv::complex<intval> > phi3_path3;
ub::vector< kv::complex<intval> > phi4_path3;
//////////////////////////////////////////////////////////////// parallel start ///////////////////////////////////////////////////
...
#pragma omp section
{
  ...
  //
  /////// Compute the analytic continuation on the path gamma_{3}
  phi1_vec.resize(2*n);
  //
  for (int i = 0; i < n; i++) {
  ...
  vec_odefunc_anticlockwise< kv::complex<intval> > f3(x3,y3,r3);
  start1 = -1;
  end1 = 1;
  std::cout << "Computing phi1 along the path gamma_{3}..." << '\n';
  ...
  if (r == 0) {
    std::cout << "phi1_path3: Cannot calculate solution.\n";
  } else if (r == 1) {
    std::cout << "phi1_path3: Solution incomplitely calculated until t = " << end1 << ".\n";
  } else if (r == 3) {
    std::cout << "phi1_path3: Solution calculated until t = " << end1 << ".\n";
  } else {
    std::cout << "phi1_path3: Solution completely calculated until t = " << end1 << ".\n";
  }
  //
  phi1_path3.resize(n);
  for (int i = 0; i < n; i++) {
    phi1_path3(i).real() = phi1_vec(i);
    phi1_path3(i).imag() = phi1_vec(i+n);
  }
  std::cout << "phi1_final: " << phi1_path3 << '\n';
...
#pragma omp section
{
  ...
  start2 = -1;
  end2 = 1;
  std::cout << "Computing phi2 along the path gamma_{3}..." << '\n';
  r = kv::odelong_maffine(
    f3,
    phi2_vec,
    start2,
  ...
  if (r == 0) {
    std::cout << "phi2_path3: Cannot calculate solution.\n";
  } else if (r == 1) {
    std::cout << "phi2_path3: Solution incomplitely calculated until t = " << end2 << ".\n";
  } else if (r == 3) {
    std::cout << "phi2_path3: Solution calculated until t = " << end2 << ".\n";
  } else {
    std::cout << "phi2_path3: Solution completely calculated until t = " << end2 << ".\n";
  }
  //
  phi2_path3.resize(n);
  for (int i = 0; i < n; i++) {
    phi2_path3(i).real() = phi2_vec(i);
    phi2_path3(i).imag() = phi2_vec(i+n);
  }
  std::cout << "phi2_final: " << phi2_path3 << '\n';
  std::cout << "thread = " << omp_get_thread_num() << '\n';
}
///////////////////////////////////////////////////////////////// Computing phi3 ///////////////////////////////////////////////////
#pragma omp section
{
  ...
  start3 = -1;
  end3 = 1;
  std::cout << "Computing phi3 along the path gamma_{3}..." << '\n';
  r = kv::odelong_maffine(
    f3,
    phi3_vec,
    start3,
  ...
  if (r == 0) {
    std::cout << "phi3_path3: Cannot calculate solution.\n";
  } else if (r == 1) {
    std::cout << "phi3_path3: Solution incomplitely calculated until t = " << end3 << ".\n";
  } else if (r == 3) {
    std::cout << "phi3_path3: Solution calculated until t = " << end3 << ".\n";
  } else {
    std::cout << "phi3_path3: Solution completely calculated until t = " << end3 << ".\n";
  }
  //
  phi3_path3.resize(n);
  for (int i = 0; i < n; i++) {
    phi3_path3(i).real() = phi3_vec(i);
    phi3_path3(i).imag() = phi3_vec(i+n);
  }
  std::cout << "phi3_final: " << phi3_path3 << '\n';
  std::cout << "thread = " << omp_get_thread_num() << '\n';
}
///////////////////////////////////////////////////////////////// Computing phi4 ///////////////////////////////////////////////////
#pragma omp section
{
  ...
  start4 = -1;
  end4 = 1;
  std::cout << "Computing phi4 along the path gamma_{3}..." << '\n';
  r = kv::odelong_maffine(
    f3,
    phi4_vec,
    start4,
  ...
  if (r == 0) {
    std::cout << "phi4_path3: Cannot calculate solution.\n";
  } else if (r == 1) {
    std::cout << "phi4_path3: Solution incomplitely calculated until t = " << end4 << ".\n";
  } else if (r == 3) {
    std::cout << "phi4_path3: Solution calculated until t = " << end4 << ".\n";
  } else {
    std::cout << "phi4_path3: Solution completely calculated until t = " << end4 << ".\n";
  }
  //
  phi4_path3.resize(n);
  for (int i = 0; i < n; i++) {
    phi4_path3(i).real() = phi4_vec(i);
    phi4_path3(i).imag() = phi4_vec(i+n);
  }
  std::cout << "phi4_final: " << phi4_path3 << '\n';
  std::cout << "thread = " << omp_get_thread_num() << '\n';
}
}
//////////////////////////////////////////////////////////////// parallel end ///////////////////////////////////////////////////////
